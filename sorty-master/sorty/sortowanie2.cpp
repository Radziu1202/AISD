...
void shellSort(int *arr, int n)
{
//zaczynamy z mo¿liwie jak najwiekszym gap i potem go zmniejszamy dwukrotnie
...
void merge(int *arr, int l, int m, int r)
{
    ...
    /* skopiuj pozosta³e elementy L jesli jakies zosta³y*/
    while (i < n1)
    {
        arr[k] = L[i];
        i++;
    ...
    /* skopiuj pozosta³e elementy R jesli jakies zosta³y */
    while (j < n2)
    {
        arr[k] = R[j];
        j++;
...
void mergeSort(int *arr, int l, int r)
{
    if (l < r)
    {
        ...
        // sortowanie pierwszej po³owy i drugiej
        mergeSort(arr, l, m);
        mergeSort(arr, m+1, r);
